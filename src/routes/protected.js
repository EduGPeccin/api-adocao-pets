...
router.get('/pets', authenticateToken, authorizeRole('admin'), ProtectedController.listPets);
// Define a rota GET /pets que chama o método listPets do ProtectedController
router.get('/pets/:id', authenticateToken, authorizeRole('admin'), ProtectedController.getPetsById);
// Define a rota GET /pets/:id que chama o método getPetsById do ProtectedController
router.post('/pets', authenticateToken, authorizeRole('admin'), ProtectedController.createPets);
// Define a rota POST /pets que chama o método createPets do ProtectedController
router.put('/pets/:id', authenticateToken, authorizeRole('admin'), ProtectedController.updatePets);
// Define a rota PUT /pets/:id que chama o método updatePets do ProtectedController
router.delete('/pets/:id', authenticateToken, authorizeRole('admin'), ProtectedController.deletePets);
